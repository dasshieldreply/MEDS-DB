select * from meds_processing_job where job_number=102341;
SELECT * from job_lookups where type='Data Type'  and description ='Observed Physical Data';--usage = 'BIOMASS';
