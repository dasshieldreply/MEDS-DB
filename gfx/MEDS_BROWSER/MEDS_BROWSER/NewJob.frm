...
Private Sub AddToJobButton_Click()
    ...
    SQLQuery = "Select * from meds_processing_job where meic_number = " & MEICNumber.Text & _
               " and data_type = '" & ProcessingJobDataType.Text & "'"
    Set Results = OraDatabase.CreateDynaset(SQLQuery, 0&)
...
Private Sub MEICNumber_Click()
    ...
    If MEICNumber.Text <> "" Then
        ...
        SQLQuery = "Select meds_cruise_number,caveat, local_datum, descriptor, ido, " & _
                   ...
                   "where meic_number = " & MEICNumber.Text & " and " & _
                   "data_type = '" & ProcessingJobDataType.Text & "'"
...
Private Sub StartDataEdit()
    ...
    If MEICNumber.Text <> "" And ProcessingJobDataType.Text <> "" Then
        ...
        SQLQuery = "SELECT job_number from meds_processing_job where meic_number = " & _
                   MEICNumber.Text & " and Data_Type = '" & _
